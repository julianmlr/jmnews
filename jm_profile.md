...
- Berliner Platzausbauprogramm Jugend
- Wohnraum für soziale Träger (Senat / IBB)
- Trägerwohnungen (IBB)
- Aktion Mensch Investitionsförderung
- Deutsche Fernsehlotterie / Deutsches Hilfswerk
- KfW IKU 148, KfW 297/298/299, KfW 270
- AMIF (Asyl-, Migrations- und Integrationsfonds, BAMF)
- ESF Plus Berlin
- CERV (Citizens, Equality, Rights and Values)
- SolarPLUS, Effiziente GebäudePLUS, BENE 2
- EFRE Berlin / Brandenburg
- Stiftungen: Eduard-Winter, Software AG Stiftung, Berliner Sparkassenstiftung, Auridis
- Berliner Senatszuwendungen Jugendhilfe
...
- BRVJug Berlin (Berliner Rahmenvertrag Jugendhilfe)
- Tagessatz-Verhandlungen Berlin
- Heimaufsicht-Vorgaben Berlin/Brandenburg
- BauGB-Änderungen für soziale Einrichtungen
...
- Blankenfelde-Mahlow, Ludwigsfelde, Trebbin, Rangsdorf
...
- Tarifvertrag TV-L Berlin
- AVR Diakonie, Paritätischer

### Bautechnik und Immobilien
- BIM Berlin Vergaben Erbbaurechte
- Soziale Wohnraumförderung Berlin
- KS-Wand, Wasserstrichklinker, Modulbau für Soziales
...
## AUSSCHLUSSFILTER (NICHT senden)
- Sportnachrichten
- Lokale Vereinsmeldungen ohne sozialen Bezug
- Bundes-/Landtagswahlen allgemein
- Wetterberichte
- Verkehrsmeldungen außer Köpenick/Altglienicke kritisch
- Promi-/Boulevard-Nachrichten
- Werbung und PR ohne Förderbezug

## SUCHBEGRIFFE für Volltextfilterung
...
- "SGB VIII" allgemein
- "Kinderschutz" Bundesebene
- "Fachkräftemangel" Soziales
- "AVR" / "TV-L"

## QUELLENPRIORISIERUNG

### Tier 1 (höchste Priorität)
- berlin.de/sen/bjf (Senatsverwaltung BJF)
- ibb.de (Investitionsbank Berlin)
- mbjs.brandenburg.de
- bezirksamt-treptow-koepenick.berlin.de
- foerderportal.deutsches-hilfswerk.de
- aktion-mensch.de
- bamf.de (AMIF Calls)
- kfw.de Förderprogramme

### Tier 2 (wichtige Branchenquellen)
- jugendhilfeportal.de
- paritaet-berlin.de
- diakonie-portal.de Berlin
- liga-berlin.de
- vpk-brandenburg.de
- sozial.de
- sozialwirtschaft.de
...
- maerkische-allgemeine.de (Brandenburg)
- lr-online.de (Lausitz)

### Tier 4 (Hintergrund)
- bundesregierung.de (KJSG, Gesetzesentwürfe)
- sozialgesetzbuch-sgb.de
- bundesanzeiger.de (Insolvenzen, Jahresabschlüsse)
- nexxt-change.org (Übernahmen)

## PERSÖNLICHE EXKLUSIONEN
- Keine Nachrichten zu Mallorca-Immobilien (Wegzug erst ab 2028+)
- Keine US-/internationale Wirtschaftsnachrichten
- Keine Bundeswahlen-Detailbericht
- Keine Kommerz-Newsletter

## SCHLÜSSELAKTEURE (Name-Tracking)
...
## LANGFRISTIGE BEOBACHTUNG (für quartalsweise Recherche)
- Tessin/Lugano CEM-Markt
- Como/Varese Comunità Educative
- Polen Kinderheim-Markt (Wegzug-Option)
...
3. **MITTEL**: Marktbewegungen, Rechtsänderungen, Personal-/Bauthemen
4. **HINTERGRUND**: Branchentrends, Personalia, Bundesentwicklung

Pro Action-Item im Briefing nach Möglichkeit angeben:
- Direktlink
- Antragsfrist falls vorhanden
- Empfohlene Aktion (Antrag stellen / Anruf / archivieren)

---

## CLASSIFICATION RULES (für den Haiku-Filter)
